...
module top_level
  ...
  wire clk_in1_0_1;
  wire ext_reset_in_0_1;
  wire mux_tester_0_request_1;
  wire mux_tester_0_request_2;
  wire [31:0]mux_tester_0_value_1;
  wire [31:0]mux_tester_0_value_2;
  wire qspi_mux_grant_1;
  wire qspi_mux_grant_2;
  wire [31:0]qspi_mux_mux_out;
  ...
  top_level_mux_tester_0_0 mux_tester
       (.S_AXI_ARADDR({system_interconnect_M01_AXI_ARADDR,system_interconnect_M01_AXI_ARADDR,system_interconnect_M01_AXI_ARADDR,system_interconnect_M01_AXI_ARADDR,system_interconnect_M01_AXI_ARADDR,system_interconnect_M01_AXI_ARADDR,system_interconnect_M01_AXI_ARADDR,system_interconnect_M01_AXI_ARADDR}),
        ...
        .request_1(mux_tester_0_request_1),
        .request_2(mux_tester_0_request_2),
        .resetn(source_100mhz_sys_resetn),
        .value_1(mux_tester_0_value_1),
        .value_2(mux_tester_0_value_2));
  top_level_qspi_mux_0_0 qspi_mux
       (.clk(source_100mhz_sys_clk),
        .grant_1(qspi_mux_grant_1),
        .grant_2(qspi_mux_grant_2),
        .mux_in1(mux_tester_0_value_1),
        .mux_in2(mux_tester_0_value_2),
        .mux_out(qspi_mux_mux_out),
        .request_1(mux_tester_0_request_1),
        .request_2(mux_tester_0_request_2),
        .resetn(source_100mhz_sys_resetn));
  ...
  top_level_system_ila_0_0 system_ila
       (.clk(source_100mhz_sys_clk),
        .probe0(mux_tester_0_request_1),
        .probe1(mux_tester_0_request_2),
        .probe2(qspi_mux_grant_1),
        .probe3(qspi_mux_grant_2),
        .probe4(qspi_mux_mux_out[0]));
